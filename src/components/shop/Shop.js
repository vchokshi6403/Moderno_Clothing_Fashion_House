            ...
            <div className="product shopCover">
                <div className="container">
                    ...
                    <div className="category">
                        ...
                        <div className="categoryClass" onClick={() => handleCategoryClick('women')}>
                        ...
                        <div className="categoryClass" onClick={() => handleCategoryClick('men')}>
                            <button className='category-item'>
                                <img src={men} alt="" />
                            </button>
                            <span>Men</span>
                        ...
                        <div className="categoryClass" onClick={() => handleCategoryClick('kids')}>
                            <button className='category-item'>
                                <img src={kids} alt="" />
                            </button>
                            <span>Kids</span>
                        ...
                        <div className="categoryClass" onClick={() => handleCategoryClick('accessories')}>
                            <button className='category-item'>
